...
The partition cuts the tree where the product changes its question. One file holds the whole institutional axis, 113 KB after gzip on a real exercise. One small file per leaf holds the object of the spending, 421 bytes in the median.
